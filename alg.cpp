...
//Âîçâðàùàåò ÷èñëî ñèìâîëîâ â ñòðîêå s ñîâïàäàþùèõ ñ i1 è i2 ïîçèöèé
...
//Çàïèñûâàåò â a z-ôóíêöèþ ñòðîêè s
...
//Ñïåöèàëüíàÿ êîíêàòåíàöèÿ ñòðîê s1 è s2
...
//Âîçâðàùàåò õåøü ïîäñòðîêè ñòðîêè s ñ íà÷àëîì â i1, êîíöîì â i2 - 1 ïî ìîäóëþ 2^64
...
//Âîçâðàùàåò i íàèáîëåå ñïîñîáñòâóþùåå áûñòðîäåéñòâèþ îïðåäåëåíèÿ ïîçèöèé ïîäñòðîê subs â ñòðîêå s
static long long find_i(char* s, char* subs) {
	...
	if (i < 0 || i >= 1 << 54) {
		...
		if (i <= max && i > 0)
			printf("Îæèäàåìàÿ âåðîÿòíîñòü ëîæíîãî ñîâïàäåíèÿ ïðîñòûõ ÷èñåë %f\n", 2.53 / ns);
...
//Åñëè i ïðîñòîå ÷èñëî âîçâðàùàåò 1, èíà÷å 0
...
//Âîçâðàùàåò ìîäóëü äëÿ àëãîðèòìà Ðàáèíà-Êàðïà
...
//Âîçâðàùàåò õåøü ïîäñòðîêè ñòðîêè s ñ íà÷àëîì â i1, êîíöîì â i2 ïî ìîäóëþ q
...
//Ïîëó÷àåò ìàññèâ a ãðàíåé ïîäñòðîê s 
...
//Ïðåîáðàçóåò ìàññèâ a ãðàíåé ïîäñòðîê s â îïòèìàëüíûé äëÿ ÊÌÏ âèä
...
//Èíèöèàëèçèðóåò ìàññèâ a ðàçìåðà n ÷èñëîì x
...
//Ïîëó÷àåò ìàññèâ âåëè÷èí ñäâèãîâ a äëÿ ÁÌÕ àëãîðèòìà ïî îáðàçó subs
...
int basic_bmh(char* s, char* subs, int* b) {
	...
	int ns = strlen(s);
	int i = n;
	int k = 0; //Ðàçìåð ìàññèâà ðåçóëüòàòà
	while (i < ns) {
		int j = n;
		int i1 = 0;
...
//Âîçâðàùàåò 1 åñëè óêàçàòåëü p1 óêàçûâàåò íà íà÷àëî ïàëèíäðîìà à p2 íà åãî êîíåö, èíà÷å âîçâðàùàåò 0
...
//Âîçâðàùàåò ÷èñëî ïàëèíäðîìîâ íå÷åòíîé äëèíû â s
...
//Âîçâðàùàåò ÷èñëî ïàëèíäðîìîâ ÷åòíîé äëèíû â s
...
//Çàïèñûâàåò â ìàññèâ a õåøè ïðåôèêñîâ ñòðîêè s ïî îñíîâàíèþ p
...
//Çàïèñûâàåò â ìàññèâ a õåøè ñóôôèêñîâ ñòðîêè s ïî îñíîâàíèþ p
...
//Çàïèñûâàåò â ìàññèâ a ñòåïåíè ÷èñëà p äî ñòåïåíè n
...
//Âîçâðàùàåò çíà÷åíèå 1, åñëè ñ l ïî r ïîçèöèþ â ñòðîêå ëåæèò ïàëèíäðîì, äëÿ ýòîãî èñïîëüçóåò ìàññèâ õåøåé ïðåôèêñîâ ñòðîêè a, ñóôôèêñîâ b, îñíîâàíèé c, èíà÷å âîçâðàùàåò 0
...
long long hash_pal(char* s) {
	...
	hash_degree_p(c, n, p);
	int l, r, m;
	long long t; // Äëÿ õðàíåíèÿ ÷èñëà ïàëèíäðîìîâ â ïîçèöèè
	long long res = 0; // Äëÿ õðàíåíèÿ ÷èñëà ïàëèíäðîìîâ â ñòðîêå
